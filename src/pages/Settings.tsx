...
const Settings = () => {
  ...
  const seoTitle = currentLanguage === 'es' 
    ? 'Configuración - 21 Días Hábito Tracker'
    : 'Settings - 21 Days Habit Tracker';
  const seoDescription = currentLanguage === 'es'
    ...
    <>
      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="space-y-6">
          ...
          {/* Reward System */}
          <section className="bg-white rounded-lg shadow-sm border border-gray-200 p-6" aria-labelledby="rewards-section">
            <header className="flex items-center gap-2 mb-4">
              <Gift className="w-5 h-5 text-green-600" aria-hidden="true" />
              <h2 className="text-lg font-semibold text-gray-900" id="rewards-section">
            ...
            <div className="space-y-4">
              <div>
                <label htmlFor="daily-reward" className="block text-sm font-medium text-gray-700 mb-2">
                  <Trophy className="w-4 h-4 inline mr-1" aria-hidden="true" />
                  {t('settings.rewards.daily')}
                </label>
                <input
                  id="daily-reward"
                  type="text"
                  ...
                  placeholder={t('settings.rewards.dailyPlaceholder')}
                />
              </div>
              
              <div>
                <label htmlFor="weekly-reward" className="block text-sm font-medium text-gray-700 mb-2">
                  <Star className="w-4 h-4 inline mr-1" aria-hidden="true" />
                  {t('settings.rewards.weekly')}
                </label>
                <input
                  id="weekly-reward"
                  type="text"
                  ...
                  className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                  placeholder={t('settings.rewards.weeklyPlaceholder')}
                />
              </div>
              
              <div>
                <label htmlFor="final-reward" className="block text-sm font-medium text-gray-700 mb-2">
                  <Gift className="w-4 h-4 inline mr-1" aria-hidden="true" />
                  {t('settings.rewards.final')}
                </label>
                <input
                  id="final-reward"
                  type="text"
                  ...
                  className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                  placeholder={t('settings.rewards.finalPlaceholder')}
                />
              </div>
          ...
          {/* Language Settings */}
          <section className="bg-white rounded-lg shadow-sm border border-gray-200 p-6" aria-labelledby="language-section">
            <header className="flex items-center gap-2 mb-4">
              <Globe className="w-5 h-5 text-blue-600" aria-hidden="true" />
              <h2 className="text-lg font-semibold text-gray-900" id="language-section">
          ...
          {/* Data Management */}
          <section className="bg-white rounded-lg shadow-sm border border-gray-200 p-6" aria-labelledby="data-section">
            <header className="flex items-center gap-2 mb-4">
              <Download className="w-5 h-5 text-purple-600" aria-hidden="true" />
              <h2 className="text-lg font-semibold text-gray-900" id="data-section">
