  ...
  return (
    <>
      ...
      <ConfirmationModal
        ...
        message={t("home.reset.message")}
        confirmText={t("home.reset.button")}
        confirmButtonClass="bg-blue-600 hover:bg-blue-700 dark:bg-blue-700 dark:hover:bg-blue-600 text-white"
        singleButton={true}
      />
    </>
  );
