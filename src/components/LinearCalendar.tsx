    ...
    <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
      ...
      <div className="grid grid-cols-7 gap-2 sm:gap-3">
        {Array.from({ length: 21 }, (_, index) => {
          ...
          return (
            <div
              key={index}
              className={`relative w-10 h-10 sm:w-12 sm:h-12 rounded-full border-2 flex items-center justify-center text-sm font-medium transition-all duration-200 ${
      ...
      <div className="flex flex-wrap gap-4 mt-8 pt-4 border-t border-gray-200">
        <div className="flex items-center gap-2">
          ...
          <span className="text-sm text-gray-600">{t('home.calendar.dayCompleted')}</span>
        </div>
        <div className="flex items-center gap-2">
          <div className="w-4 h-4 rounded-full bg-blue-500 ring-2 ring-blue-200"></div>
          <span className="text-sm text-gray-600">{t('home.calendar.currentDay')}</span>
        </div>
        <div className="flex items-center gap-2">
          <div className="w-4 h-4 rounded-full bg-gray-200"></div>
          <span className="text-sm text-gray-600">{t('home.calendar.futureDay')}</span>
        </div>
      </div>
    </div>
  );
